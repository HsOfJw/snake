(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/MoveLogic.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '207cadIEpZOE6v0sCwI82z4', 'MoveLogic', __filename);
// scripts/MoveLogic.js
...
var MoveLogic = cc.Class({
    ...
    moveLogic: function moveLogic(moveDirection) {
        this.isMoving = true;
    ...
    rotateLogic: function rotateLogic(direction) {},
    ...
    //指定一个方向，判断是否可以移动
    isCanMove: function isCanMove(moveDirection, isNotMoveLogic) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=MoveLogic.js.map
